...
- `../source/first_deck_review.md` — reviewed source semantics, provisional families, and note corrections to preserve
...
1. Validate parsing against `../source/first_deck_review.md`: 125 reviewed cards, 0 blocked or deferred, required fields present, and exactly one family assignment per card.
