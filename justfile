...
board-creator-open board="data/boards/base_game.json" layout="data/layouts/base_game_layout.json":
...
game-viewer players="p1,p2" board="data/boards/base_game.json" layout="data/layouts/base_game_layout.json" card="data/cards/catalog.json" setup="data/decks/base_setup.json":
    & {{python}} -m interface.game_viewer --players {{players}} --board-path {{board}} --layout-path {{layout}} --card-path {{card}} --setup-path {{setup}}

replay-viewer replay="artifacts/replay.json" board="data/boards/base_game.json" layout="data/layouts/base_game_layout.json":
